...
class TaobaolistSpiderMiddleware(object):
...
class SeleniumMiddleware(object):
    ...
    # passed objects.
    #利用downloadmiddleware中间件来对接selenium，并获取httpresponse响应，替换原始请求
    ...
    def process_request(self, request, spider):
        '''最开始的request不用原来的请求方式，而是通过selenium渲染后直接返回httpresponse对象'''
        ...
        try:
           ...
           #这里返回响应的参数url=request.url,body=self.browser.page_source,request=request,encoding='utf-8',status=200
